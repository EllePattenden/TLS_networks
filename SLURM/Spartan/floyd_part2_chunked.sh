...
#SBATCH --ntasks=1 
#SBATCH --array=1-2000           
#SBATCH --mem-per-cpu=2500            # TEST MEMORY REQS NOW THAT WE AREN'T SAVING ALL THE BLOODY NETWORKS

# chunked version of code to get around max_array 
# cd /data/gpfs/projects/punim1783/jobs    
# chunk=21     # a number 1-22 ** number 22 only has 840 rows, so ammend when get around to that! 
               # working backwards from 22 now 
